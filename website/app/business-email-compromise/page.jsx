...
export function generateMetadata({ searchParams }) {
  ...
  return {
    title: isEn
      ...
      : 'Заштита од деловни емаил измами (ДЕИ)',
    description: isEn
      ? 'Learn how BEC attacks use deception, impersonation, and social engineering, and how SMB teams can stop them early.'
      : 'Дознајте како нападите од деловни емаил измами (ДЕИ) користат измама, имперсонација и социјален инженеринг, и како МСП тимовите да ги стопираат навреме.',
    alternates: {
...
export default function BusinessEmailCompromisePage({ searchParams }) {
  ...
  const copy = isEn
    ...
    : {
      eyebrow: 'Деловни емаил измами (ДЕИ)',
      title: 'Како да спречите ДЕИ напади базирани на измама и имперсонација',
      lede: 'ДЕИ нападите не се само технички. Тие користат злоупотреба на доверба, итност и психолошки притисок за тимовите да споделат чувствителни податоци или да префрлат средства. Најбезбедниот пристап е силен процес на верификација поддржан со рана детекција.',
        cta: 'Побарај демо',
      card1Title: 'Најчести ДЕИ модели',
        ...
        card2Title: 'Контроли што го намалуваат ДЕИ ризикот',
